                ...
                <div className="col-span-1 flex-1">
                    <div className="flex justify-center flex-col ">
                        ...
                        <form
                            ...
                            <button onClick={handleSignup} className="w-32 text-center border-0 rounded-md cursor-pointer py-1 px-3 text-white bg-[#B55D51] hover:bg-[#974E44] transition duration-300">
                                Sign up
                            </button>
                        </form>
                        <div>
                            ...
                            <div className="flex flex-1 justify-between">
                                <button onClick={handleSignUpWithGoogle} className="flex justify-center items-center w-72 border rounded-lg py-1 hover:bg-slate-100">
